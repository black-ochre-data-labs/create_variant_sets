...
OUTFILE="${WD}/vcf/1000GP_SNV_INDEL_panhuman_all_0.5.vcf"
...
do
  ...
  zcat ${CURFILE} |\
	  bcftools view -G -H  -i '(INFO/AC_EUR + INFO/AC_EAS + INFO/AC_AMR + INFO/AC_SAS + AC_AFR) > 0.5*(INFO/AN_EUR + INFO/AN_EAS + INFO/AN_AMR + INFO/AN_SAS + AN_AFR)' |\
